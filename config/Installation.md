...
2. Start the server.
3. **If this instance should host the Discord bot:** [Setup the bot module.](../modules/Bot.md) **If you do not wish this instance to run the Discord bot, make sure to disable the module in `/DiscordBridge/Modules/bot.yml.`**
