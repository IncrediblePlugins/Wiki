...
3. Execute `/link translations` in the Discord server and provide the requested parameters to complete the account setup.
4. After reloading the translations page, the translations become visible to you. You can view all translations [here](https://translations.incredibleplugins.com/projects). You need to be logged in and have your account linked to a verified Discord account.
