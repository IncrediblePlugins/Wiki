...
3. Execute `/link translations` in the Discord server and provide the requested parameters to complete the account setup. If you don't do this, the locale files won't be visiable to you.
