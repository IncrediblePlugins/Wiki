...
To send an ally request from a land:

`/land <land> relation ally add <land or nation>`

To remove an ally:

`/land <land> relation ally remove <land or nation>`
...
To mark another land or nation as an enemy from a land:

`/land <land> relation enemy add <land or nation>`

To request peace or remove the enemy relation:

`/land <land> relation enemy remove <land or nation>`

# Nation Relations

If your land is part of a nation, the nation may manage relations for its member lands.

The command works the same way as land relations, just under `/nation <nation> relation ...`:

* `/nation <nation> relation ally add <land or nation>`
* `/nation <nation> relation ally remove <land or nation>`
* `/nation <nation> relation enemy add <land or nation>`
* `/nation <nation> relation enemy remove <land or nation>`

# Menu

You can also manage relations through `/land <land> relation`, `/nation <nation> relation`, or the relations button in the land or nation menu.
