...
Stand where you want to claim and use `/lands claim`.

If you do not own a land yet, Lands can create one for you and claim the area around you. If you already have a land selected with `/lands edit <land>`, the claim is added to that land.

If you want to choose the land name first, use `/lands create` before claiming.
...
Use `/lands trust <player> <area>` to trust them only in a specific area.
...
Use `/lands untrust <player>` to remove a player from your land.

Use `/lands untrust <player> <area>` to remove them only from a specific area.
