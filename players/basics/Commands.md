...
`/lands create <name> <tag>`\
Create a new land. Depending on the server you might be able to use color codes and hex color.\
The tag can be the short version of your land name. Example: land name = Test, tag = T\
If your server allows spaces in land names, the command will have the arguments in reversed order: ``/lands create <tag> <name>``
