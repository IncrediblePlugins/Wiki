# UpgradeableSpawners Player Wiki

This section explains UpgradeableSpawners from a player's point of view.

Start with the basics if you are new to upgradeable spawners. Use the other pages when you want to
understand upgrades, entity types, butcher mode, teleportation, or common status messages.
