...
5. [Setup player limits.](https://wiki.incredibleplugins.com/general/locale-and-config/limits)
6. [Setup permissions.](../permissions/Recommended-Permission-Setup.md)
