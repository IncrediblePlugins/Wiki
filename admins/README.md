...
| --- | --- | --- |
| Setup | [Installation](configuration/Installation.md) | Installing Lands and updating the plugin. |
| Setup | [Database](configuration/Database.md) | Database types, migration, backups, MySQL, and Redis synchronization. |
...
| Economy and Progression | [PlaceholderAPI Placeholders](configuration/PlaceholderAPI-Placeholders.md) | PlaceholderAPI placeholders provided by Lands. |
| Rules, Flags, and Gameplay | [Roles and Role Flags](configuration/Roles-and-their-Flags.md) | All role flags and their toggle or bypass permissions. |
...
| Permissions and Staff Tools | [Player Command Permissions](permissions/Player-Commands.md) | Player-facing command permissions for server admins. |
