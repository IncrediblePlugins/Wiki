...
* [Frequently asked Questions](basics/Frequently-asked-Questions)
* [Start as a Player](basics/How-to-Start-as-a-Player)
* [Commands](basics/Commands)
* [About Sub Areas](basics/Sub-Areas)
* [Rent and Sell System](basics/Rent-System)
* [Nations](basics/Nations)
* [Wars](basics/Wars)
* [For Server-Admins](basics/Administration)

## Configuration

* [Installation](configuration/Installation)
* [Frequently asked Questions](configuration/Frequently-asked-Config-Questions)
* [Database](configuration/Database)
* [Playtime Rewards](configuration/Playtime-Rewards)
* [Leaderboards](configuration/Leaderboards)
...
* [Roles and their Flags](configuration/Roles-and-their-Flags)
* [Natural flags](configuration/Natural-Flags)
* [Player Personal Settings](configuration/Player-Personal-Settings)
* [Wars](configuration/Wars-Config)
* [Levels](configuration/levels)
* [Events](https://github.com/IncrediblePlugins/PluginFrameworkAPI/wiki/Events)
* [Regeneration](configuration/Unclaim-and-Wilderness-Regeneration)
